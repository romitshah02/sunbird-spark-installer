...
dependency "storage" {
    ...
    mock_outputs = {
      ...
      # azurerm_dial_state_container_public = "dummy-container-dail"  # Moved to addons/dial/opentofu
...
inputs = {
  ...
  # dial_state_container_public        = dependency.storage.outputs.azurerm_dial_state_container_public  # Moved to addons/dial/opentofu
