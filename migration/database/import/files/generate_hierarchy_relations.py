...
Steps:
  1. Export identifiers from dv_hierarchy_store.content_hierarchy in YugaByte
...
Optional env vars:
  ...
  KEYSPACE              (default: dv_hierarchy_store — in-cluster this is
...
KEYSPACE = os.environ.get("KEYSPACE", "dv_hierarchy_store")
