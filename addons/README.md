...
A comprehensive discussion forum system based on NodeBB for social learning and collaboration. Includes:
- **Discussion Middleware**: Service layer for forum integration
- **NodeBB**: Forum platform
- **Groups Service**: Learning group management

**Documentation**: [addons/discussion-forum/README.md](discussion-forum/README.md)
...
3. **Addon Images** (`addons/images.yaml`)
   - Centralized management of container images (registry, repository, tags) for all addon components.
